...
Текст каждой для каждой строки начинается с новой строки.
...
Краткий обзор по __MarkDown__ для начинающих. Остальное можно найти в интернете в большом количестве.